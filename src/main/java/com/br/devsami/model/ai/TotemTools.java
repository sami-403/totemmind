...
public class TotemTools {
    ...
    public String buscarFuncionarioPorNome(String nome) {
        ...
        if (employees.isEmpty()) return "Nenhum funcionário encontrado.";
     ...
     * 2. IA lê o histórico, sabe que o ID é 5, e chama esta tool passando employeeId=5.
    ...
    public String gerarRelatorioDeSatisfacao(Long employeeId, String startDate, String endDate, String tipoGrafico) {
